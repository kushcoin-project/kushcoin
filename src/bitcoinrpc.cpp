...
{
    return GetBoolArg("-testnet", false) ? 18345 : 31543;
}
...
Value stop(const Array& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "Stop KushCoin server (and possibly override the detachdb config value).");
